<template>
  <div id="audiovisual_index">
    ...
    <ejs-chart
      ...
      v-if="audiovisuals_list.length !== 0"
    >
      <e-series-collection>
        <e-series
...
export default {
  ...
  data() {
    return {
          ...
          template: Vue.component("columnTemplate", {
            ...
            methods: {
              ...
              finally_method(action, error) {
                this.loading = false;
                if (!error) {
                  this.$parent.$parent.load_audiovisuals();
      ...
      //products_childs: {}, //* Objeto de productos hijos de los Audiovisuales
        ...
        .then((response) => {
          ...
          this.audiovisuals_list.forEach((audiovisual) => {
            let index = this.series_data.findIndex(
              (serie) => serie.years === parseInt(audiovisual.añoFinAud.toString())
            );
            if (index != -1) {
