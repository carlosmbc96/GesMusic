  ...
  <div class="col-md-12">
    ...
    >
      <div style="min-height: 600px">
        <div id="empleado_index">
          <h1 style="color: white !important">Empleados</h1>
...
import modal_management from "./Modal_Gestionar_Empleado";
import {
  GridPlugin,
  Edit,
  Filter,
...
export default {
  ...
  data() {
    return {
      ...
      tooltip: {
        enable: true,
        header: "Empleados por sexo",
        format: "${point.x} : ${point.y} Empleados",
          ...
          template: Vue.component("columnTemplate", {
            ...
            methods: {
              confirm_change_status() {
                let content = `Esta acción de eliminación lógica es revercible.`;
                let error = false;
                if (this.checked) {
                              ...
                              buttons: [
                                [
                                  ...
                                  (instance, toast) => {
                                    ...
                                    axios
                                      .delete(
                                        "empleados/desactivar/" + this.data.id
                                      )
                                      .catch((errors) => {
                                        error = true;
                                      })
                  ...
                  this.$toast.question(
                    "¿Esta acción ativará el Empleado?",
                    "Confirmación",
                    {
                      timeout: 5000,
                      close: false,
                                ...
                                buttons: [
                                  [
                                    ...
                                    (instance, toast) => {
                                      this.loading = true;
                                      axios
                                        .get("empleados/restaurar/" + this.data.id)
                                        .catch((errors) => {
                                          error = true;
                                        })
                                        .finally(() => {
              ...
              finally_method(action, error) {
                this.loading = false;
                if (!error) {
                  this.$parent.$parent.$parent.load_empleados();
                  this.checked = !this.checked;
                  this.$toast.success(
                    `El Empleado se ${action} correctamente`,
                    "¡Éxito!",
                    {
                      timeout: 2000,
          ...
          template: Vue.component("columnTemplate", {
            ...
            methods: {
              ...
              del_physical_btn_click(args) {
                let content = `Esta acción de eliminación es irrevercible`;
                this.$toast.question(content, "Confirmación", {
                  timeout: 5000,
                  close: false,
                  overlay: true,
                            ...
                            buttons: [
                              [
                                ...
                                (instance, toast) => {
                                  ...
                                  axios
                                    .delete(`empleados/eliminar/${this.data.id}`)
                                    .then((ress) => {
      ...
      empleados_list: [], //* Lista de Empleados que es cargada en la tabla
      row_selected: {}, //* Fila de la tabla seleccionada | Empleado seleccionado
      empleados_list: [],
      temas_childs: [],
      visible_details: false, //* variable para visualizar el modal de detalles del Empleado
      visible_management: false, //* variable para visualizar el modal de gestión del Empleado
  ...
  methods: {
    ...
    /*
     * Método que carga los Empleados de la bd
     */
    load_empleados() {
      ...
      axios
        .post("/empleados/listar"/*, { relations: ["fonogramas"] }*/)
        .then((response) => {
          this.empleados_list = response.data;
          this.series_data = [];
          this.empleados_list.forEach((empleado) => {
            let index = this.series_data.findIndex(
              (serie) => serie.sexo === empleado.sexoEmpl
            );
            if (index !== -1) {
              this.series_data[index].empleados += 1;
            } else {
              this.series_data.push({
                sexo: empleado.sexoEmpl,
                empleados: 1,
              });
            }
          });
          this.series_data.sort((x, y) => {
            return x.sexo - y.sexo;
          });
          if (
            this.series_data.length > 0 &&
            this.series_data[this.series_data.length - 1].empleados < 5
          ) {
    ...
    panel_export_click(args) {
      ...
      if (args === "pdf") {
        ...
        excelExportProperties.fileName = "Reporte_Empleado.xlsx";
        this.$refs.gridObj.getColumns()[7].visible = false;
        this.$refs.gridObj.excelExport(excelExportProperties);
      } else if (args === "csv") {
        excelExportProperties.fileName = "Reporte_Empleados.csv";
        this.$refs.gridObj.getColumns()[7].visible = false;
...
<style>
#empleado_index .e-headercontent,
#empleado_index .e-sortfilter,
#empleado_index thead,
#empleado_index tr,
#empleado_index td,
#empleado_index th,
#empleado_index .e-pagercontainer,
#empleado_index .e-pagerdropdown,
#empleado_index .e-first,
#empleado_index .e-prev,
#empleado_index .e-numericcontainer,
#empleado_index .e-next,
#empleado_index .e-last,
#empleado_index .e-table,
#empleado_index .e-input-group,
#empleado_index .e-content,
#empleado_index .e-toolbar-items,
#empleado_index .e-tbar-btn,
#empleado_index .e-toolbar-item,
#empleado_index .e-gridheader,
#empleado_index .e-gridcontent,
#empleado_index .e-gridpager,
#empleado_index .e-toolbar {
  background-color: transparent !important;
}
#empleado_index .e-grid {
...
#empleado_index .e-grid,
#empleado_index .e-toolbar,
#empleado_index .e-grid .e-headercontent {
  border-color: transparent !important;
}
#empleado_index .e-row:hover {
  background-color: rgba(115, 25, 84, 0.1) !important;
}
#empleado_index .e-detailrowcollapse .e-icon-grightarrow,
#empleado_index .e-detailrowexpand .e-icon-gdownarrow,
#empleado_index thead span,
#empleado_index .e-icon-filter {
  color: rgb(115, 25, 84) !important;
  font-weight: bold !important;
}
#empleado_index .ant-switch-inner {
  width: auto !important;
}
#empleado_index .e-badge.e-badge-success:not(.e-badge-ghost):not([href]),
