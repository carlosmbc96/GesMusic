          ...
          template: Vue.component("columnTemplate", {
            ...
            methods: {
              ...
              del_relation_btn_click(args) {
                this.$toast.question(
                  "¿Esta acción eliminará el vínculo del Fonograma en este Producto?",
                  "Confirmación",
                  {
                    timeout: 5000,
                    close: false,
                    ...
                    buttons: [
                      [
                        ...
                        (instance, toast) => {
                          this.$toast.question(
                            "¿Desea desvincular el Fonograma?",
                            "Confirmación",
                            {
                              timeout: 5000,
                              close: false,
                              ...
                              buttons: [
                                [
                                  ...
                                  (instance, toast) => {
                                    ...
                                    axios
                                      .post(`productos/desvincularFong`, {
                                      ...
                                      .then((ress) => {
                                        ...
                                        this.$toast.success(
                                          "El Fonograma ha sido desvinculado correctamente",
                                          "¡Éxito!",
