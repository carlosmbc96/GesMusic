  ...
  <div class="col-md-12">
    ...
    >
      <div style="min-height: 600px">
        <div id="tema_index">
          <h1 style="color: white !important">Temas</h1>
...
export default {
  ...
  data() {
    return {
          ...
          template: Vue.component("columnTemplate", {
            ...
            methods: {
              ...
              del_physical_btn_click(args) {
                ...
                let content = `Esta acción de eliminación es irrevercible,<br> este Tema está asociado al Track con ISRC <strong style="color: black; font-size: inherit">${this.data.track.isrcTrk}</strong>.`;
      ...
      temas_list: [], //* Lista de temas que es cargada en la tabla
      row_selected: {}, //* Fila de la tabla seleccionada | tema seleccionado
      visible_details: false, //* variable para visualizar el modal de detalles del tema
      visible_management: false, //* variable para visualizar el modal de gestión del tema
  ...
  methods: {
    ...
    /*
     * Método que carga los temas de la bd
     */
    load_temas() {
      ...
      axios.post("/temas/listar", { relations: ["track"] }).then((response) => {
        ...
        this.temas_list.forEach((tema) => {
          let index = this.series_data.findIndex((serie) =>
            tema.deleted_at != null
              ? serie.status === "Inactivo"
              : serie.status === "Activo"
          );
          if (index != -1) {
            this.series_data[index].temas += 1;
          } else {
            this.series_data.push({
              status: tema.deleted_at != null ? "Inactivo" : "Activo",
              temas: 1,
            });
          }
        });
...
<style>
#tema_index .e-headercontent,
#tema_index .e-sortfilter,
#tema_index thead,
#tema_index tr,
#tema_index td,
#tema_index th,
#tema_index .e-pagercontainer,
#tema_index .e-pagerdropdown,
#tema_index .e-first,
#tema_index .e-prev,
#tema_index .e-numericcontainer,
#tema_index .e-next,
#tema_index .e-last,
#tema_index .e-table,
#tema_index .e-input-group,
#tema_index .e-content,
#tema_index .e-toolbar-items,
#tema_index .e-tbar-btn,
#tema_index .e-toolbar-item,
#tema_index .e-gridheader,
#tema_index .e-gridcontent,
#tema_index .e-gridpager,
#tema_index .e-toolbar {
...
#tema_index .e-grid,
#tema_index .e-toolbar,
#tema_index .e-grid .e-headercontent {
  border-color: transparent !important;
}
#tema_index .e-row:hover {
  background-color: rgba(115, 25, 84, 0.1) !important;
}
#tema_index .e-detailrowcollapse .e-icon-grightarrow,
#tema_index .e-detailrowexpand .e-icon-gdownarrow,
#tema_index thead span,
#tema_index .e-icon-filter {
  color: rgb(115, 25, 84) !important;
  font-weight: bold !important;
}
#tema_index .ant-switch-inner {
  width: auto !important;
}
#tema_index .e-badge.e-badge-success:not(.e-badge-ghost):not([href]),
