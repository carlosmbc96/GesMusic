<template>
  <div>
    <a-modal :closable="false" width="60%" :visible="show" id="transfer_modal_temas">
      ...
      .then((response) => {
        for (let i = 0; i < response.data.length; i++) {
          this.mockData.push({
            ...
            codig: response.data[i].codigTema,
            title: response.data[i].tituloTem,
          });
...
<style>
#transfer_modal_temas .ant-modal {
  margin-left: auto !important;
  margin-top: -31px !important;
}
#transfer_modal_temas .ant-modal-content {
  background-color: rgba(255, 255, 255, 0.95) !important;
}
#transfer_modal_temas .ant-btn-primary-disabled,
