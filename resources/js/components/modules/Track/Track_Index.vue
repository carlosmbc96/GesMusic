  ...
  export default {
    ...
    data() {
      return {
            ...
            template: Vue.component('columnTemplate', {
              ...
              methods: {
                ...
                finally_method(action, error) {
                  this.loading = false;
                  if (!error) {
                    this.$parent.$parent.load_tracks();
        ...
        //products_childs: {}, //* Objeto de productos hijos de los Tracks
    ...
    methods: {
      ...
      /*
       * Método que carga los Tracks de la bd
       */
      load_tracks() {
        axios
          ...
          .then((response) => {
            ...
            this.series_data = [];
            /* this.tracks_list.forEach((project) => {
...
<style>
  #track_index .e-headercontent,
  #track_index .e-sortfilter,
  #track_index thead,
  #track_index tr,
  #track_index td,
  #track_index th,
  #track_index .e-pagercontainer,
  #track_index .e-pagerdropdown,
  #track_index .e-first,
  #track_index .e-prev,
  #track_index .e-numericcontainer,
  #track_index .e-next,
  #track_index .e-last,
  #track_index .e-table,
  #track_index .e-input-group,
  #track_index .e-content,
  #track_index .e-toolbar-items,
  #track_index .e-tbar-btn,
  #track_index .e-toolbar-item,
  #track_index .e-gridheader,
  #track_index .e-gridcontent,
  #track_index .e-gridpager,
  #track_index .e-toolbar {
  ...
  #track_index .e-grid,
  #track_index .e-toolbar,
  #track_index .e-grid .e-headercontent {
    border-color: transparent !important;
  }
  #track_index .e-row:hover {
    background-color: rgba(115, 25, 84, 0.1) !important;
  }
  #track_index .e-detailrowcollapse .e-icon-grightarrow,
  #track_index .e-detailrowexpand .e-icon-gdownarrow,
  #track_index thead span,
  #track_index .e-icon-filter {
    color: rgb(115, 25, 84) !important;
    font-weight: bold !important;
  }
  #track_index .ant-switch-inner {
    width: auto !important;
  }
  #track_index .e-badge.e-badge-success:not(.e-badge-ghost):not([href]),
