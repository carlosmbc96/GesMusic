  ...
  <div class="col-md-12">
    ...
    >
      <div style="min-height: 600px">
        <div id="usuario_index">
          <h1 style="color: white !important">Usuarios</h1>
...
import modal_management from "./Modal_Gestionar_Usuario";
import {
  GridPlugin,
  Edit,
  Filter,
...
export default {
  ...
  data() {
    return {
      ...
      tooltip: {
        enable: true,
        header: "Usuarios por Estado",
        format: "${point.x} : ${point.y} Usuarios",
            ...
            methods: {
              confirm_change_status() {
                ...
                if (this.checked) {
                              ...
                              buttons: [
                                [
                                  ...
                                  (instance, toast) => {
                                    ...
                                    axios
                                      .delete(
                                        "usuarios/desactivar/" + this.data.id
                                      )
                                      .catch((errors) => {
                                        error = true;
                                      })
                  ...
                  this.$toast.question(
                    "¿Esta acción ativará el Usuario?",
                    "Confirmación",
                    {
                      timeout: 5000,
                      close: false,
                                ...
                                buttons: [
                                  [
                                    ...
                                    (instance, toast) => {
                                      this.loading = true;
                                      axios
                                        .get("usuarios/restaurar/" + this.data.id)
                                        .catch((errors) => {
                                          error = true;
                                        })
                                        .finally(() => {
              ...
              finally_method(action, error) {
                this.loading = false;
                if (!error) {
                  this.$parent.$parent.$parent.load_usuarios();
                  this.checked = !this.checked;
                  this.$toast.success(
                    `El Usuario se ${action} correctamente`,
                    "¡Éxito!",
                    {
                      timeout: 2000,
                            ...
                            buttons: [
                              [
                                ...
                                (instance, toast) => {
                                  ...
                                  axios
                                    .delete(`usuarios/eliminar/${this.data.id}`)
                                    .then((ress) => {
      ...
      usuarios_list: [], //* Lista de Usuarios que es cargada en la tabla
      row_selected: {}, //* Fila de la tabla seleccionada | Usuario seleccionado
      usuarios_list: [],
      temas_childs: [],
      visible_details: false, //* variable para visualizar el modal de detalles del Usuario
      visible_management: false, //* variable para visualizar el modal de gestión del Usuario
  ...
  methods: {
    ...
    /*
     * Método que carga los Usuarios de la bd
     */
    load_usuarios() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.series_data = [];
          this.usuarios_list.forEach((usuario) => {
            let index = this.series_data.findIndex(
              (serie) => serie.estado === usuario.estadoUser
            );
            if (index !== -1) {
              this.series_data[index].usuarios += 1;
            } else {
              this.series_data.push({
                estado: usuario.estadoUser,
                usuarios: 1,
              });
            }
          });
          this.series_data.sort((x, y) => {
            return x.estado - y.estado;
          });
          if (
            this.series_data.length > 0 &&
            this.series_data[this.series_data.length - 1].usuarios < 5
          ) {
    ...
    panel_export_click(args) {
      ...
      if (args === "pdf") {
        ...
        excelExportProperties.fileName = "Reporte_Usuario.xlsx";
        this.$refs.gridObj.getColumns()[7].visible = false;
        this.$refs.gridObj.excelExport(excelExportProperties);
      } else if (args === "csv") {
        excelExportProperties.fileName = "Reporte_Usuarios.csv";
        this.$refs.gridObj.getColumns()[7].visible = false;
...
<style>
#usuario_index .e-headercontent,
#usuario_index .e-sortfilter,
#usuario_index thead,
#usuario_index tr,
#usuario_index td,
#usuario_index th,
#usuario_index .e-pagercontainer,
#usuario_index .e-pagerdropdown,
#usuario_index .e-first,
#usuario_index .e-prev,
#usuario_index .e-numericcontainer,
#usuario_index .e-next,
#usuario_index .e-last,
#usuario_index .e-table,
#usuario_index .e-input-group,
#usuario_index .e-content,
#usuario_index .e-toolbar-items,
#usuario_index .e-tbar-btn,
#usuario_index .e-toolbar-item,
#usuario_index .e-gridheader,
#usuario_index .e-gridcontent,
#usuario_index .e-gridpager,
#usuario_index .e-toolbar {
  background-color: transparent !important;
}
#usuario_index .e-grid {
...
#usuario_index .e-grid,
#usuario_index .e-toolbar,
#usuario_index .e-grid .e-headercontent {
  border-color: transparent !important;
}
#usuario_index .e-row:hover {
  background-color: rgba(115, 25, 84, 0.1) !important;
}
#usuario_index .e-detailrowcollapse .e-icon-grightarrow,
#usuario_index .e-detailrowexpand .e-icon-gdownarrow,
#usuario_index thead span,
#usuario_index .e-icon-filter {
  color: rgb(115, 25, 84) !important;
  font-weight: bold !important;
}
#usuario_index .ant-switch-inner {
  width: auto !important;
}
#usuario_index .e-badge.e-badge-success:not(.e-badge-ghost):not([href]),
