...
<head>
	...
	<link rel="shortcut icon" href="../assets/images/favicon de la aplicación.png" type="image/icon">
	...
	<!-- BEGIN PAGE LEVEL PLUGINS bootstrap-fileinput -->
	<link href="../assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css" />
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS bootstrap-sweetalert -->
	<link href="../assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
	<link href="../assets/global/plugins/bootstrap-sweetalert/sweetalert.css" rel="stylesheet" type="text/css" />
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS bootstrap-tagsinput -->
